...
import Numbers from "./Components/layouts/searchBar/Numbers"
    ...
    <div>
      <BrowserRouter>
          ...
          <Switch>
                ...
                <Route exact path='/states/IN-MH' render={props => (
                    <Fragment>
                      <Maharashtra maharashtra={maharashtra}/>
                    </Fragment>
                )}/>
                <Route exact path='/states/IN-AP' render={props => (
                    <Fragment>
                ...
                <Route exact path='/states/IN-AR' render={props => (
                    <Fragment>
                      <Arunachal arunachal={arunachal}/>
                    </Fragment>
                )}/>
                <Route exact path='/states/IN-AN' render={props => (
                    <Fragment>
                      <Andaman andaman={andaman}/>
                    </Fragment>
                )}/>
                <Route exact path='/states/IN-AS' render={props => (
                    <Fragment>
                      <Assam assam={assam}/>
                    </Fragment>
                )}/>
                <Route exact path='/states/IN-WB' render={props => (
                    <Fragment>
                      <Bengal westbengal={westbengal}/>
                    </Fragment>
                )}/>
                <Route exact path='/states/IN-BR' render={props => (
                    <Fragment>
                      <Bihar bihar={bihar}/>
                    </Fragment>
                )}/>
                <Route exact path='/states/IN-CH' render={props => (
                    <Fragment>
                      <Chandigarh chandigarh={chandigarh}/>
                    </Fragment>
                )}/>
                <Route exact path='/states/IN-CT' render={props => (
                    <Fragment>
                      <Chhattisgarh chhattisgarh={chhattisgarh}/>
                    </Fragment>
                )}/>
                <Route exact path='/states/IN-DL' render={props => (
                    <Fragment>
                      <Delhi delhi={delhi}/>
                    </Fragment>
                )}/>
                <Route exact path='/states/IN-DN' render={props => (
                    <Fragment>
                      <Dadra dadra={dadra}/>
                    </Fragment>
                )}/>
                <Route exact path='/states/IN-GA' render={props => (
                    <Fragment>
                      <Goa goa={goa}/>
                    </Fragment>
                )}/>
                <Route exact path='/states/IN-GJ' render={props => (
                    <Fragment>
                      <Gujarat gujarat={gujarat}/>
                    </Fragment>
                )}/>
                <Route exact path='/states/IN-HP' render={props => (
                    <Fragment>
                      <Himachal himachal={himachal}/>
                    </Fragment>
                )}/>
                <Route exact path='/states/IN-HR' render={props => (
                    <Fragment>
                      <Haryana haryana={haryana}/>
                    </Fragment>
                )}/>
                <Route exact path='/states/IN-JH' render={props => (
                    <Fragment>
                      <Jharkhand jharkhand={jharkhand}/>
                    </Fragment>
                )}/>
                <Route exact path='/states/IN-JK' render={props => (
                    <Fragment>
                      <JammuKashmir jk={jk}/>
                    </Fragment>
                )}/>
                <Route exact path='/states/IN-KA' render={props => (
                    <Fragment>
                      <Karnataka karnataka={karnataka}/>
                    </Fragment>
                )}/>
                <Route exact path='/states/IN-KL' render={props => (
                    <Fragment>
                      <Kerala kerala={kerala}/>
                    </Fragment>
                )}/>
                <Route exact path='/states/IN-LK' render={props => (
                    <Fragment>
                      <Ladakh ladakh={ladakh}/>
                    </Fragment>
                )}/>
                <Route exact path='/states/IN-LD' render={props => (
                    <Fragment>
                      <Lakshwadeep lakshwadeep={lakshwadeep}/>
                    </Fragment>
                )}/>
                <Route exact path='/states/IN-ML' render={props => (
                    <Fragment>
                      <Meghalaya meghalaya={meghalaya}/>
                    </Fragment>
                )}/>
                <Route exact path='/states/IN-MN' render={props => (
                    <Fragment>
                      <Manipur manipur={manipur}/>
                    </Fragment>
                )}/>
                <Route exact path='/states/IN-MP' render={props => (
                    <Fragment>
                      <MadhyaPradesh madhyapradesh={madhyapradesh}/>
                    </Fragment>
                )}/>
                <Route exact path='/states/IN-MZ' render={props => (
                    <Fragment>
                      <Mizoram mizoram={mizoram}/>
                    </Fragment>
                )}/>
                <Route exact path='/states/IN-NL' render={props => (
                    <Fragment>
                      <Nagaland nagaland={nagaland}/>
                    </Fragment>
                )}/>
                <Route exact path='/states/IN-OR' render={props => (
                    <Fragment>
                      <Odisha odisha={odisha}/>
                    </Fragment>
                )}/>
                <Route exact path='/states/IN-PB' render={props => (
                    <Fragment>
                      <Punjab punjab={punjab}/>
                    </Fragment>
                )}/>
                <Route exact path='/states/IN-PY' render={props => (
                    <Fragment>
                      <Puducherry puducherry={puducherry}/>
                    </Fragment>
                )}/>
                <Route exact path='/states/IN-RJ' render={props => (
                  <Fragment>
                    <Rajasthan rajasthan={rajasthan}/>
                  </Fragment>
                )}/>
                <Route exact path='/states/IN-SK' render={props => (
                  <Fragment>
                    <Sikkim sikkim={sikkim}/>
                  </Fragment>
                )}/>
                <Route exact path='/states/IN-TG' render={props => (
                  <Fragment>
                    <Telengana telengana={telengana}/>
                  </Fragment>
                )}/>
                <Route exact path='/states/IN-TN' render={props => (
                  <Fragment>
                    <TamilNadu tamilnadu={tamilnadu}/>
                  </Fragment>
                )}/>
                <Route exact path='/states/IN-TR' render={props => (
                  <Fragment>
                    <Tripura tripura={tripura}/>
                  </Fragment>
                )}/>
                <Route exact path='/states/IN-UP' render={props => (
                  <Fragment>
                    <UttarPradesh uttarpradesh={uttarpradesh}/>
                  </Fragment>
                )}/>
                <Route exact path='/states/IN-UT' render={props => (
                  <Fragment>
